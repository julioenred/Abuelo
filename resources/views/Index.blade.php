...
<html>
    ...
    <body>
        ...
        <img class='bg hidden-md hidden-lg' src="/img/carousel-1.jpg" alt="">
        <img class='bg hidden-md hidden-lg' src="/img/carousel-2.jpg" alt="">
        <img class='bg hidden-md hidden-lg' src="/img/carousel-3.jpg" alt="">
